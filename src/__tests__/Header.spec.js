...
describe("<Header />", () => {
  describe("Success", () => {
    it("renders the header component", () => {
      const { queryByTestId } = render(<Header darkMode setDarkMode />);
    ...
    it("renders the quick add task overlay, and then closes it using onClick", () => {
    ...
    it("renders the quick add task overlay, and then closes it using onKeyDown", () => {
      const { queryByTestId } = render(<Header />);
      expect(queryByTestId("header")).toBeTruthy();
